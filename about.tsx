    ...
    <section id="about" className="relative py-20 lg:py-28">
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 lg:grid-cols-[1.15fr_0.85fr]">
        <Reveal>
          ...
          <p className="mt-4 max-w-xl text-muted">CodeX Viber combines coding, design, artificial intelligence, and robotics to transform ideas into useful digital experiences.</p>
        </Reveal>
        <Reveal delayMs={80}>
          <article className="rounded-2xl p-6 panel">
            <div className="flex items-center gap-4">
              <div className="flex size-16 items-center justify-center overflow-hidden rounded-2xl bg-bg">
                <img src="/logo.jpg" alt="CodeX Viber logo" className="h-full w-full object-cover" width={128} height={128} />
              </div>
              <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted">Aaditya founded CodeX Viber to put engineering and design in the same room.</p>
